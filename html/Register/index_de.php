...
<?php include 'lang/language_de.php';?>
...
<table align="center">
<tr align="center">
<center><h1><font><?php echo "$heading_01"; ?></font></h1><a href="index.php">Switch to English</a></center>
  ...
  <td>
    ...
    <form name="jqbsForm" id="jqbsForm" action="assets/formmailatt.php" method="post" enctype='multipart/form-data' autocomplete="on">
      ...
      <div class="input-row" style="margin-bottom:-20px;">
        ...
        <table>
  <tr>
  <span id="divcount" style="font-size:0.8em; color:#999999; margin-top:4px; float:right;"><center><?php echo $disclaim_02;?><i><a href="/Register/assets/ELC Dragonboard Sweeps 2017-Final.htm">Official Sweepstake Rules</a></i></center></span>
</tr>
</table>
      </div>
    </form>
